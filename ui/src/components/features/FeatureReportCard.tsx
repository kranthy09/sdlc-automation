          ...
          <div className="pt-1">
            ...
            {configSteps.length > 0 ? (
              ...
              <p className="text-xs italic text-text-muted">
                Configuration steps were not generated by the LLM for this PARTIAL_FIT. Refer to the D365 capability specification and MS Learn documentation for guidance.
              </p>
            )}
          </div>
        )}
