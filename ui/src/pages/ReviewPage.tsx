                ...
                <div className="rounded-lg border border-partial/20 bg-partial-muted/10 p-3">
                  ...
                  {item.configuration_steps && item.configuration_steps.length > 0 ? (
                    ...
                    <p className="text-xs text-text-muted italic">
                      Configuration steps were not generated by the LLM for this requirement. This is a PARTIAL_FIT — manual D365 configuration guidance may be required. Consider flagging this item for analyst review.
                    </p>
                  )}
                </div>
              )}
