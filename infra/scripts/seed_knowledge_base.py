...
def main() -> None:
    ...
    parser.add_argument("--source", default="lite", choices=["lite", "full"], help="YAML source variant")
    parser.add_argument("--reset", action="store_true", help="Drop and recreate collection before seeding")
    parser.add_argument(
        "--qdrant-url",
    ...
    # 7. Build Points
    points: list[Point] = []
    for cap, dense_vec, desc in zip(caps, dense_vectors, descriptions):
